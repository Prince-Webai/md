...
const Dashboard = () => {
    ...
    const quickActions = [
        { icon: Plus, title: 'New Job', desc: 'Create new', path: '/jobs', color: 'bg-green-50 text-green-600', mColor: 'bg-[#E6F4EA] text-[#0A8043]' },
        { icon: Wrench, title: 'Parts', desc: 'Inventory', path: '/inventory', color: 'bg-slate-100 text-slate-700', mColor: 'bg-[#F1F5F9] text-[#334155]' },
        { icon: Users, title: 'Customers', desc: 'All customers', path: '/customers', color: 'bg-slate-100 text-slate-700', mColor: 'bg-[#F1F5F9] text-[#334155]' },
